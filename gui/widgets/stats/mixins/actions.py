...
if TYPE_CHECKING:
    ...
    _HostBase_StatsActionsMixin = StatsWidget
else:
    _HostBase_StatsActionsMixin = object

class StatsActionsMixin(_HostBase_StatsActionsMixin):
    """Actions behavior."""
    ...
    def _listing_to_item(self, listing: dict) -> Item:
        return Item(
