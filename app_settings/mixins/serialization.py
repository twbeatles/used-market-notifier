...
if TYPE_CHECKING:
    ...
    _HostBase_SettingsSerializationMixin = SettingsManager
else:
    _HostBase_SettingsSerializationMixin = object

class SettingsSerializationMixin(_HostBase_SettingsSerializationMixin):
