...
if TYPE_CHECKING:
    ...
    _HostBase_PlaywrightNavigationMixin = PlaywrightScraper
else:
    _HostBase_PlaywrightNavigationMixin = object

class PlaywrightNavigationMixin(_HostBase_PlaywrightNavigationMixin):
    """Navigation behavior."""
