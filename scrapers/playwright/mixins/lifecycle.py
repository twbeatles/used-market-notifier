...
if TYPE_CHECKING:
    ...
    _HostBase_PlaywrightLifecycleMixin = PlaywrightScraper
else:
    _HostBase_PlaywrightLifecycleMixin = object

class PlaywrightLifecycleMixin(_HostBase_PlaywrightLifecycleMixin):
    """Lifecycle behavior."""
