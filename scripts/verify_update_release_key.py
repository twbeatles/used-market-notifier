"""릴리즈 서명 개인키가 바이너리에 심은 공개키와 같은 쌍인지 확인합니다."""
...
from updater.manifest import canonical_manifest_payload, verify_release_manifest
...
def verify_release_keypair(private_key_b64: str, public_key_b64: str) -> None:
    ...
    payload = {
        "version": "999.0.0",
        "artifact_url": "https://example.invalid/UsedMarketNotifier.exe",
        "sha256": "0" * 64,
        "size": 1,
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--private-key-env", default="UMN_UPDATE_PRIVATE_KEY_B64")
    parser.add_argument("--public-key-env", default="UMN_UPDATE_PUBLIC_KEY_B64")
